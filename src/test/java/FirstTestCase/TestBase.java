...
public class TestBase {
    ...
    public void setUp() {
        ...
        capabilities.setCapability("videoName", "ParmaTestCaseForFirstSendOrder.mp4");
        capabilities.setCapability("name", "ParmaTestCaseForFirstSendOrder");
    ...
    @Step("Открываю сайт")
    public void openURL() {
        open("https://parmabar.ru/");
    }

    @Step("Перехожу в рандомный пункт меню для оформления тестового заказа")
    public void mathRandomHead() {
        List<SelenideElement> mathRandomHead = elements(By.xpath("//div[contains(@class, \"swiper-slide\")]//a[contains(@class, \"scroll-nav_link\") and not (@href = \"/menu/combo\") and not (@href = \"/menu/napitki\") and not (@href = \"/menu/supy\") and not (@href = \"/menu/burgery\") and not (@href = \"/menu/pasta-rizotto\") and not (@href = \"/menu/picca\")]"));
